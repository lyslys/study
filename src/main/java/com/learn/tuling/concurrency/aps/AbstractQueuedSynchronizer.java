...
package com.learn.tuling.concurrency.aps;
...
public abstract class AbstractQueuedSynchronizer
    ...
    static final class Node {
         ...
         *
         * 条件队列里面的下一个节点的时候，prev next 一概为null 空
         *
         */
        Node nextWaiter;
    ...
    private Node addWaiter(Node mode) {
        ...
        if (pred != null) {
            ...
            node.prev = pred;
            // 2.3 CAS将节点插入同步队列的尾部
            if (compareAndSetTail(pred, node)) { //原来pred尾部的节点，替换成现在新的node节点
                pred.next = node;
                return node;
            }
        }
